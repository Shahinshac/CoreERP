...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b [&_tr]:border-white/[0.08] bg-white/[0.02]", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("py-3.5 px-4 align-middle text-sm text-foreground/90 [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
